...
void Credits::initialize() {
	...
	makeText("Player and Enemy Sprites by Open Source", glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, -4300.0f), glm::vec2(2.0f), 0, HTA::Center, VTA::Center);
	makeText("Background Art by Open Source", glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, -4600.0f), glm::vec2(2.0f), 0, HTA::Center, VTA::Center);
	makeText("Fonts by Open Source", glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, -4900.0f), glm::vec2(2.0f), 0, HTA::Center, VTA::Center);
	makeText("Bullet Art by ZUN", glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, -5200.0f), glm::vec2(2.0f), 0, HTA::Center, VTA::Center);
	makeText("Sound Effects by Open Source", glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, -5500.0f), glm::vec2(2.0f), 0, HTA::Center, VTA::Center);
	...
	makeText("Thanks for Playing!", glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, -6100.0f), glm::vec2(2.0f), 0, HTA::Center, VTA::Center);
