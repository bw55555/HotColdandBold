...
public:
	...
	std::shared_ptr<Enemy> createEnemy() override {
		...
		std::shared_ptr<Enemy> e = Enemy::makeEnemy(30.0f, enemyHitbox, getPosition(), getTexture(), this->func);
...
public:
	...
	std::shared_ptr<Enemy> createEnemy() override {
		...
		std::shared_ptr<Enemy> e = Enemy::makeEnemy(30.0f, enemyHitbox, getPosition(), getTexture(), func);
		e->customFloats.push_back(1.0f);
